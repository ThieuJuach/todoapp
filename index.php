                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            <form id="custom-card-form" action="add_task.php" method="POST">
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <input name="task_id" class="form-control" maxlength="19" placeholder="0" />
                                                                                </div>
                                                            
                                                                                <div class="mb-3">
                                                                                    <label for="card-holder-input" class="form-label">Task Description</label>
                                                                                ...
                                                                                <button class="btn btn-danger w-100 mt-3" type="submit" name="add">Add</button>
                                                                            </form>
                                                                            <!-- end card form elem -->
                                                                        </div>
                                                                    </div>
